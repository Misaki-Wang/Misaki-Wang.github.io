...
[Pointer Analysis: Context Sensitivity (nju.edu.cn)](https://cs.nju.edu.cn/tiantan/software-analysis/PTA-CS.pdf) 
...
<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113985.png" style="zoom:50%;" />

也就因此造成了分析结果的低精度，即在动态运行时i一定是1，而分析的结果认为i为NAC\(Not a constant\)：

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113990.png" style="zoom:50%;" />

如果我们使用上下文敏感的分析方式，区分不同时间对的id调用，则会得到这样的PFG：

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113988.png" style="zoom:50%;" />

对应地也就能得到更为精确的分析结果：

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113005.png" style="zoom:50%;" />
...
<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113002.png" style="zoom:50%;" />
...
<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113013.png" style="zoom:50%;" />

不过，采取C.I.+ C.S. heap进行分析时，C.S. heap就不能提高精度了。

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113393.png" style="zoom:50%;" />
...
<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113431.png" style="zoom:50%;" />

对比一下上下文不敏感指针分析的规则：

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113448.png" style="zoom:50%;" />

**唯一的区别在于，对象被加上了上下文标识。**

然后我们来看看调用如何处理。在上下文敏感的指针分析中，规则如下：

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113465.png" style="zoom: 33%;" />

再次对比一下上下文不敏感指针分析的规则：

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113489.png" style="zoom: 33%;" />

**这次我们添加了一个Select函数，它的作用是为object添加上下文标识，例如：**

* 为参数添加上下文标识

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113029.png" style="zoom: 33%;" />

* 为返回值添加上下文标识

<img src="https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311051113054.png" style="zoom:33%;" />
