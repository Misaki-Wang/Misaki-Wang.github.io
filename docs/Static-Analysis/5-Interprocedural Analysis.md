...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954952.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954962.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954595.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954649.png)

* 为什么处理super调用需要使用Dispatch函数：在下图所示情况中没有Dispatch函数时无法正确解析C类的super.foo调用：

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954937.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954955.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954975.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954158.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954674.png)

2. 处理main后向WL中加入A.foo\(\)

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954694.png)

3. 中间省略一些步骤，这里面对C.bar\(\)时，虽然会调用A.foo\(\)，但由于A.foo\(\)之前已经处理过（在集合RM中），之后不会再进行处理

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954712.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954752.png)

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954769.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954686.png)

#### 小问题

这一段有存在的必要吗？

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954705.png)
...
![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954722.png)

要记得在调用语句处kill掉表达式左边的值，否则会造成结果的不准确，如：

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954743.png)

## 过程间分析有多重要？

讲到这里，我们回到故事的开头，看看过程间分析的引入到底能带来多大的精度提高吧。上述例子应用过程间分析的完整推导如下：

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954432.png)

而如果只做过程内分析，则**精度大大下降**：

![](https://picgo-wbyz.oss-cn-nanjing.aliyuncs.com/202311011954459.png)
